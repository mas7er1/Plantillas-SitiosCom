(function($) {
    'use strict';
			 ...
			 /*==== one page menu  ====*/
			  ...
			  $(".one_page .webcy_menu .nav_scroll").onePageNav({ currentClass: "current", changeHash: !1, scrollSpeed: 1000, scrollOffset: top_offset, scrollThreshold: 0.5, filter: "", easing: "swing" });
